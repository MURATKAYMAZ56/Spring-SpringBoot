...
public class StudentRestController {
	...
	// PostCOnstruct guarantees that it will be invoked only once
	...
	// define endpint for "/students/{studentId}" -return list of students
	...
	// Add an exceptional handeler using @ExceptionHandeler
